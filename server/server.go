...
func (server *Server) Serve(w http.ResponseWriter, req *http.Request) {
	uri := req.URL.Path
	paths := strings.Split(strings.TrimPrefix(uri, "/"), "/")
